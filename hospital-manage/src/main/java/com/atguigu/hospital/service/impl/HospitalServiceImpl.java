...
public class HospitalServiceImpl implements HospitalService {
    ...
    public int submitOrder(String scheduleId) {

//
//        Schedule schedule = this.getSchedule(scheduleId);
//        //Schedule schedule = summitOrderForUpdate(scheduleId);
//
...
//        return count;
    ...
    @Override
    public Schedule summitOrderForUpdate(String scheduleId) {
        return hospitalMapper.summitOrderForUpdate(scheduleId);
    }
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        int availableNumber = schedule.getAvailableNumber() - 1;
        if (availableNumber > 0) {
            System.out.println("fuck, the avail is" + availableNumber);
            schedule.setAvailableNumber(availableNumber);
            hospitalMapper.updateById(schedule);
