...
public class HospitalController {
	...
	@GetMapping("/order/{id}/submitOrder")
	public void testSubmitOrder(@PathVariable("id") String scheduleId) throws InterruptedException {
		int i  = hospitalService.submitOrder(scheduleId);
		System.out.println(i);
	}

	@GetMapping("/order/{id}/submitOrder2")
	public Schedule testSubmitOrder2(@PathVariable("id") String scheduleId) throws InterruptedException {
		Schedule schedule = hospitalService.summitOrderForUpdate(scheduleId);
		return schedule;
	}
